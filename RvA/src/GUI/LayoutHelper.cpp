...
Rectangle LayoutHelper::arrangePositionAndSize(const Vector2& position, const Vector2& size, const Rectangle& availableArea, HAlign hAlign, VAlign vAlign)
{
    ...
    case HAlign::Left:
        ...
        break;
    case HAlign::Right:
        rec.x = availableArea.x + availableArea.width - size.x - position.x;
        break;
    case HAlign::Center:
        rec.x = availableArea.x + (availableArea.width - size.x) / 2 + position.x;
        break;
    case HAlign::Stretch:
        rec.x = availableArea.x + position.x;
    ...
    case VAlign::Top:
        ...
        break;
    case VAlign::Bottom:
        rec.y = availableArea.y + availableArea.height - size.y - position.y;
        break;
    case VAlign::Center:
        rec.y = availableArea.y + (availableArea.height - size.y) / 2 + position.y;
        break;
    }

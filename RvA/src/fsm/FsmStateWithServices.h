...
/**
 * @brief A utility abstract class used to store a service locator. It's just containing syntactic sugar to retrieve a
 * service. Injection is still provided by the user who's building the FSM.
 */
namespace flow {

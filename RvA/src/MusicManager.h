...
public:
	...
	Sound& getButtonClick() { SetSoundVolume(s_buttonClick, 0.2f); return s_buttonClick; }
	Sound& getLaserShoot() { return s_laserShoot; }
	Sound& getLongLaser() { return s_longLaser; }
	Sound& getAlienDeath() { return s_alienDeath; }
